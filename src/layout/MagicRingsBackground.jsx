...
const magicRingsVertexShader = `
void main() {
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}
`;

const magicRingsFragmentShader = `
...
/**
 * Fond animé WebGL (anneaux concentriques pulsants). Se désactive silencieusement
 * si WebGL2 n'est pas disponible (voir le check isWebGL2 dans l'effet).
 */
export default function MagicRingsBackground({
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({ vertexShader: magicRingsVertexShader, fragmentShader: magicRingsFragmentShader, uniforms, transparent: true });
