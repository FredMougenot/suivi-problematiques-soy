  ...
  if (errors.length === 0) {
    return (
      <div className="error-none">
        ...
        <div style={{ fontSize: '1.125rem', fontWeight: 600, color: 'var(--emerald)', marginBottom: 8 }}>Aucune erreur détectée</div>
        ...
        <div className="error-item" key={i} style={{ '--item-color': e.quart.color, '--item-bg': e.quart.bg }}>
          ...
          <div className="error-truck">
            <div style={{ display: 'flex', alignItems: 'center', gap: 0, flexWrap: 'wrap' }}>
              ...
              {e.id && <span style={{ fontFamily: 'var(--font-mono)', fontSize: '1rem', fontWeight: 700, color: 'var(--text-primary)' }} title="ID Supabase">{e.id}</span>}
            </div>
