  ...
  return (
    <div className="tool-main">
      ...
      <div className="kpi-row">
        <div className="kpi-electric copper"><div className="kpi copper" onClick={() => goToRegistre('')}><div className="kpi-top"><div className="kpi-lbl">Total actif</div></div><div className="kpi-val">{kpis.total}</div><div className="kpi-sub">Voir le registre →</div></div></div>
        <div className="kpi-electric ruby"><div className="kpi ruby" onClick={() => goToRegistre('À traiter')}><div className="kpi-top"><div className="kpi-lbl">À traiter</div></div><div className="kpi-val">{kpis.ouvert}</div><div className="kpi-sub">Voir le registre →</div></div></div>
        <div className="kpi-electric sapphire"><div className="kpi sapphire" onClick={() => goToRegistre('En cours')}><div className="kpi-top"><div className="kpi-lbl">En cours</div></div><div className="kpi-val">{kpis.cours}</div><div className="kpi-sub">Voir le registre →</div></div></div>
        <div className="kpi-electric emerald"><div className="kpi emerald" onClick={() => goToRegistre('Résolu')}><div className="kpi-top"><div className="kpi-lbl">Résolues</div></div><div className="kpi-val">{kpis.resolu}</div><div className="kpi-sub">Voir le registre →</div></div></div>
        <div className="kpi-electric amber"><div className="kpi amber" onClick={goToIncompletes}><div className="kpi-top"><div className="kpi-lbl">Incomplètes</div></div><div className="kpi-val">{kpis.incomplet}</div><div className="kpi-sub">Voir le registre →</div></div></div>
      </div>
