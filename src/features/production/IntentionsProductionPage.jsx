...
export default function IntentionsProductionPage() {
  ...
  // Charger les valeurs du jour une fois disponibles ; si aucune ligne
  // n'existe encore pour aujourd'hui, initialiser à ON par défaut + sauvegarde auto.
  useEffect(() => {
